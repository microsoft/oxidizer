...
#[data_privacy::classified(TestTaxonomy::PublicData)]
#[derive(Clone, Copy)]
pub struct PublicI64(
    /// The classified integer value.
    pub i64,
);
...
#[data_privacy::classified(TestTaxonomy::PublicData)]
#[derive(Clone, Copy)]
pub struct PublicF64(
    /// The classified floating-point value.
    pub f64,
);
...
#[data_privacy::classified(TestTaxonomy::PublicData)]
#[derive(Clone, Copy)]
pub struct PublicBool(
    /// The classified Boolean value.
    pub bool,
);
