...
- Should this crate be reexporting any types from std::fs in its public API or should we just clone the types so we're isolated?
...
- Where does thread_aware make sense?
