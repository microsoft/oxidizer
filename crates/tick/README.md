...
All clock types implement [`ThreadAware`][__link16], supporting per-core
timer isolation in thread-per-core runtime architectures.

When an [`InactiveClock`][__link17] is
[relocated][__link18] to a target thread, the underlying timer
storage is duplicated per core. After activation, each thread’s [`Clock`][__link19] and
[`ClockDriver`][__link20] operate on an independent set of timers with no
cross-thread lock contention.

[`ClockControl`][__link21] clocks are unaffected by relocation, all clones always share the same
controlled time state regardless of thread, so a single `ClockControl` can drive time for
the entire test.

See the [`runtime`][__link22] module documentation for setup examples.
...
The clock provides absolute time as `SystemTime`. See [`Clock`][__link23] documentation for detailed
information.
...
The clock provides relative time via [`Clock::instant`][__link24] and [`Stopwatch`][__link25].
...
This crate was developed as part of <a href="../..">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/tick">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGkYW0CYXSEGy4k8ldDFPOhG2VNeXtD5nnKG6EPY6OfW5wBG8g18NOFNdxpYXKEGy_QQ3DXXBTMG-wYrAGx4Q0zGwo33-kq3ZvDG8lbbk3MMbc-YWSCgmx0aHJlYWRfYXdhcmVlMC43LjCCZHRpY2tlMC4zLjA
 [__link0]: https://docs.rs/tick/0.3.0/tick/?search=ClockControl
 [__link1]: https://docs.rs/tick/0.3.0/tick/?search=Clock
 [__link10]: https://docs.rs/tick/0.3.0/tick/?search=FutureExt
 [__link11]: https://docs.rs/tick/0.3.0/tick/?search=SystemTimeExt
 ...
 [__link17]: https://docs.rs/tick/0.3.0/tick/?search=runtime::InactiveClock
 [__link18]: https://docs.rs/thread_aware/0.7.0/thread_aware/?search=ThreadAware::relocate
 [__link19]: https://docs.rs/tick/0.3.0/tick/?search=Clock
 [__link2]: https://docs.rs/tick/0.3.0/tick/?search=Clock
 [__link20]: https://docs.rs/tick/0.3.0/tick/?search=runtime::ClockDriver
 [__link21]: https://docs.rs/tick/0.3.0/tick/?search=ClockControl
 [__link22]: https://docs.rs/tick/0.3.0/tick/runtime/index.html
 [__link23]: https://docs.rs/tick/0.3.0/tick/?search=Clock
 [__link24]: https://docs.rs/tick/0.3.0/tick/?search=Clock::instant
 [__link25]: https://docs.rs/tick/0.3.0/tick/?search=Stopwatch
 [__link26]: https://tokio.rs/
 [__link27]: https://docs.rs/tick/0.3.0/tick/?search=Clock::new_tokio
 [__link28]: https://docs.rs/tick/0.3.0/tick/?search=ClockControl
 [__link29]: https://serde.rs/
 [__link3]: https://docs.rs/tick/0.3.0/tick/?search=ClockControl
 [__link30]: https://docs.rs/tick/0.3.0/tick/fmt/index.html
 [__link31]: https://github.com/microsoft/oxidizer/tree/main/crates/tick/examples
 [__link4]: https://docs.rs/tick/0.3.0/tick/?search=Stopwatch
 [__link5]: https://docs.rs/tick/0.3.0/tick/?search=Delay
 [__link6]: https://docs.rs/tick/0.3.0/tick/?search=PeriodicTimer
 [__link7]: https://docs.rs/tick/0.3.0/tick/?search=Error
 [__link8]: https://docs.rs/tick/0.3.0/tick/fmt/index.html
 [__link9]: https://docs.rs/tick/0.3.0/tick/runtime/index.html
