...
//!
//! - [`UnixSecondsTimestamp`]: Parsing and formatting of timestamps that are represented as the number of whole seconds since Unix epoch.
//!   For example, `0` represents `Thu, 1 Jan 1970 00:00:00 -0000`.
//!
//! # Examples
//!
//! ```
//! use tick::fmt::{Iso8601Timestamp, Rfc2822Timestamp, UnixSecondsTimestamp};
//!
//! // ISO 8601
...
pub use iso_8601_timestamp::Iso8601Timestamp;
pub use rfc_2822_timestamp::Rfc2822Timestamp;
pub use unix_seconds_timestamp::UnixSecondsTimestamp;
