...
- 🧩 Miscellaneous
  ...
  - feat!: rename TraceInfo into EnrichmentEntry ([#92](https://github.com/microsoft/oxidizer/pull/92))
  - feat!: rename ohno::error_trace into enrich_err ([#86](https://github.com/microsoft/oxidizer/pull/86))
