...
impl SinkId {
    /// Creates a new id from a human-readable label. The label is the identity:
    /// ids with equal labels compare and hash equal, and it drives
    /// targeted-enrichment matching.
    #[must_use]
