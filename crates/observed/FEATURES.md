...
- **Per-Sink event sampling** - `Sink::with_event_sampler` attaches a synchronous gate before processor delivery; see `EventSampler::sample` for the invocation contract
