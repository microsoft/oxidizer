...
[`Transfer::apply_current_thread`][__link8].
...
[`attach`][__link9] for async code so the
...
This crate was developed as part of <a href="https://github.com/microsoft/oxidizer">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/observed">source code</a>.
 ...
 [__link6]: https://docs.rs/observed/0.23.0/observed/?search=context::Transfer
 [__link7]: https://docs.rs/observed/0.23.0/observed/?search=enrichment::EnrichFutureExt::attach
 [__link8]: https://docs.rs/observed/0.23.0/observed/?search=context::Transfer::apply_current_thread
 [__link9]: https://docs.rs/observed/0.23.0/observed/?search=enrichment::EnrichFutureExt::attach
