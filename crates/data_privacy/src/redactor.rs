...
pub trait Redactor {
    ...
    /// # Errors
    ///
    /// This function should return [`Err`] if, and only if, the provided [`Formatter`](core::fmt::Formatter) returns [`Err`]. String redaction is considered an infallible operation;
