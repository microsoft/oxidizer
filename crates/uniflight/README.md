...
This crate was developed as part of <a href="../..">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/uniflight">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGmYW0CYXZlMC43LjJhdIQbLiTyV0MU86EbZU15e0PmecoboQ9jo59bnAEbyDXw04U13GlhYvRhcoQb4YsqHKJIO4Ebne8KVDRuJvAbVEqIpjwMtY4bZY2vS6iuAethZIKCbHRocmVhZF9hd2FyZWUwLjcuMYJpdW5pZmxpZ2h0ZTAuMi4x
 [__link0]: https://docs.rs/uniflight/0.2.1/uniflight/struct.Merger.html
 [__link1]: https://docs.rs/uniflight/0.2.1/uniflight/?search=Merger::execute
 ...
 [__link12]: https://docs.rs/uniflight/0.2.1/uniflight/struct.Merger.html
 [__link2]: https://doc.rust-lang.org/stable/std/?search=borrow::Borrow
 [__link3]: https://docs.rs/thread_aware/0.7.1/thread_aware/?search=storage::Strategy
 [__link4]: https://docs.rs/thread_aware/0.7.1/thread_aware/?search=PerProcess
 [__link5]: https://docs.rs/thread_aware/0.7.1/thread_aware/?search=PerNuma
 [__link6]: https://docs.rs/thread_aware/0.7.1/thread_aware/?search=PerCore
 [__link7]: https://docs.rs/uniflight/0.2.1/uniflight/struct.LeaderPanicked.html
 [__link8]: https://docs.rs/uniflight/0.2.1/uniflight/?search=LeaderPanicked::message
