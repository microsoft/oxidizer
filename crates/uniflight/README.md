...
This crate was developed as part of <a href="../..">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/uniflight">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGkYW0CYXSEGy4k8ldDFPOhG2VNeXtD5nnKG6EPY6OfW5wBG8g18NOFNdxpYXKEG-GLKhyiSDuBG53vClQ0bibwG1RKiKY8DLWOG2WNr0uorgHrYWSCgmx0aHJlYWRfYXdhcmVlMC43LjCCaXVuaWZsaWdodGUwLjIuMA
 [__link0]: https://docs.rs/uniflight/0.2.0/uniflight/struct.Merger.html
 [__link1]: https://docs.rs/uniflight/0.2.0/uniflight/?search=Merger::execute
 ...
 [__link12]: https://docs.rs/uniflight/0.2.0/uniflight/struct.Merger.html
 [__link2]: https://doc.rust-lang.org/stable/std/?search=borrow::Borrow
 [__link3]: https://docs.rs/thread_aware/0.7.0/thread_aware/?search=storage::Strategy
 [__link4]: https://docs.rs/thread_aware/0.7.0/thread_aware/?search=PerProcess
 [__link5]: https://docs.rs/thread_aware/0.7.0/thread_aware/?search=PerNuma
 [__link6]: https://docs.rs/thread_aware/0.7.0/thread_aware/?search=PerCore
 [__link7]: https://docs.rs/uniflight/0.2.0/uniflight/struct.LeaderPanicked.html
 [__link8]: https://docs.rs/uniflight/0.2.0/uniflight/?search=LeaderPanicked::message
