...
/// driver and context on every active worker. Each driver receives an initial zero-wait
/// [`execute_cycle`](crate::Driver::execute_cycle) before its context is published.
