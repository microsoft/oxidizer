...
/// driver and context on every active worker. Each driver receives a separate, completed
/// zero-wait [`execute_cycle`](crate::Driver::execute_cycle) before its context is published.
/// Later requests reuse that registration.
