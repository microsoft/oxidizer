...
[`DriverContext::take_completion_service`][__link9] before native side effects. Clients may be local
...
[`CompletionBudget`][__link13] limits one participant during each turn. It is cooperative residual
accounting shared with the participant, not automatic enforcement. [`ServiceStatus`][__link14] reports
remaining work or a service deadline. [`ServiceStatus::Runnable`][__link15] schedules another turn
...
[`WaitStatus::Armed`][__link16] permits that participant to sleep. The collector must preserve an
...
[`LocalDriver`][__link17] and [`LocalDrain`][__link18] hold concrete state inline and dispatch statically. They
...
thread-local; consumer contexts remain mobile through [`IoContext`][__link19]. A runtime with no native
...
[`LocalDriver::shutdown`][__link20] consumes the running owner and invokes [`Driver::shutdown`][__link21], which
closes admission and returns its concrete [`Drain`][__link22]. A [`LocalDrain`][__link23] keeps that value local.
...
required system work, and services drains fairly. [`DrainStatus::Complete`][__link24] marks graceful
...
calls neither method again. Failures remain visible through [`DriverError`][__link25], and the runtime
...
[`SystemTasks::spawn`][__link26] reports admission, not completion. Success means execution ownership
was accepted; rejection returns [`DriverError`][__link27] and promises no task execution or callback.
...
Offload tasks still use private closure boxing and dispatch through [`SystemTask::run`][__link28];
[`SystemTasks`][__link29] uses an `Arc`-backed callback. Wakers, clients, and driver-owned resources may
also allocate. Only the inline ownership wrappers themselves introduce no allocation or
dynamic dispatch.

## Example and design

The [two-thread reference runtime][__link30]
...
* [Requirements][__link31]
* [Design][__link32]
* [Completion coordination][__link33]
...
This crate was developed as part of <a href="https://github.com/microsoft/oxidizer">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/arty_io_core">source code</a>.
 ...
 [__link15]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=ServiceStatus::Runnable
 [__link16]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=WaitStatus::Armed
 [__link17]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=LocalDriver
 [__link18]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=LocalDrain
 [__link19]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=IoContext
 [__link2]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=DriverProvider
 [__link20]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=LocalDriver::shutdown
 [__link21]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=Driver::shutdown
 [__link22]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=Drain
 [__link23]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=LocalDrain
 [__link24]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=DrainStatus::Complete
 [__link25]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=DriverError
 [__link26]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=SystemTasks::spawn
 [__link27]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=DriverError
 [__link28]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=SystemTask::run
 [__link29]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=SystemTasks
 [__link3]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=IoContext::provider
 [__link30]: https://github.com/microsoft/oxidizer/blob/main/crates/arty_io_core/examples/two_thread_runtime/main.rs
 [__link31]: https://github.com/microsoft/oxidizer/blob/main/crates/arty_io_core/docs/REQUIREMENTS.md
 [__link32]: https://github.com/microsoft/oxidizer/blob/main/crates/arty_io_core/docs/DESIGN.md
 [__link33]: https://github.com/microsoft/oxidizer/blob/main/crates/arty_io_core/docs/COMPLETION_COORDINATION.md
 ...
 [__link9]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=DriverContext::take_completion_service
