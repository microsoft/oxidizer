...
clone and consumes it through [`DriverProvider::create`][__link7].
...
Provider and driver creation return [`DriverError`][__link8]. The first context request succeeds only
...
The [`DriverContext::readiness_waker`][__link9] identifies a driver service participant. The runtime
latches readiness for that participant before waking the collector. The separate
[`CompletionWaiter::waker`][__link10] interrupts the current or next blocking collection. Both handles
...
[`CompletionBudget`][__link11] limits one participant during each turn. It is cooperative residual
accounting shared with the participant, not automatic enforcement. [`ServiceStatus`][__link12] reports
remaining work or a service deadline. [`ServiceStatus::Runnable`][__link13] schedules another turn
...
[`WaitStatus::Armed`][__link14] permits that participant to sleep. The collector must preserve an
...
thread-local; consumer contexts remain mobile through [`IoContext`][__link15]. A runtime with no native
...
[`Driver::shutdown`][__link16] consumes the boxed running driver and closes admission before returning
its [`Drain`][__link17]. The drain continues service and notification preparation under the same budget
...
required system work, and services drains fairly. [`DrainStatus::Complete`][__link18] marks graceful
...
calls neither method again. Failures remain visible through [`DriverError`][__link19], and the runtime
...
[`SystemTasks::spawn`][__link20] reports admission, not completion. Success means execution ownership
was accepted; rejection returns [`DriverError`][__link21] and promises no task execution or callback.
...
The [two-thread reference runtime][__link22]
...
* [Design][__link24]
* [Completion coordination][__link25]
...
This crate was developed as part of <a href="https://github.com/microsoft/oxidizer">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/arty_io_core">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGmYW0CYXZlMC43LjJhdIQb11VxC_uAPOQbtUn4Wx2-BfAbid3Nt1Y27Pobprn8Z6FjFy9hYvRhcoQbMucilthL7VEbxoE8axvH9-gbJln5fNyBVcEbGx8C6-293UdhZIGCbGFydHlfaW9fY29yZWUwLjIuMA
 ...
 [__link10]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=CompletionWaiter::waker
 [__link11]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=CompletionBudget
 [__link12]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=ServiceStatus
 [__link13]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=ServiceStatus::Runnable
 [__link14]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=WaitStatus::Armed
 [__link15]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=IoContext
 [__link16]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=Driver::shutdown
 [__link17]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=Drain
 [__link18]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=DrainStatus::Complete
 [__link19]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=DriverError
 [__link2]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=DriverProvider
 [__link20]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=SystemTasks::spawn
 [__link21]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=DriverError
 [__link22]: https://github.com/microsoft/oxidizer/blob/main/crates/arty_io_core/examples/two_thread_runtime/main.rs
 ...
 [__link25]: https://github.com/microsoft/oxidizer/blob/main/crates/arty_io_core/docs/COMPLETION_COORDINATION.md
 ...
 [__link8]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=DriverError
 [__link9]: https://docs.rs/arty_io_core/0.2.0/arty_io_core/?search=DriverContext::readiness_waker
