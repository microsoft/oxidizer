...
//! | [`http_client_decompression`](https://github.com/microsoft/oxidizer/blob/main/crates/fetch/examples/http_client_decompression.rs) | Enables gzip response decompression against a fully mocked transport. |
