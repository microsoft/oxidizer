...
This crate was developed as part of <a href="https://github.com/microsoft/oxidizer">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/fetch">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGmYW0CYXZlMC43LjJhdIQb11VxC_uAPOQbtUn4Wx2-BfAbid3Nt1Y27Pobprn8Z6FjFy9hYvRhcoQbRcdYrc3P77cbVjz14MYzPFkbTKiKwHYuBbcbSr09Rcd_lPZhZIeCZWJ5dGVzZjEuMTIuMIJoYnl0ZXNidWZlMC43LjCCZWZldGNoZjAuMTQuMIJvaHR0cF9leHRlbnNpb25zZTAuNy4xgmdsYXllcmVkZTAuMy42gmhzZWF0YmVsdGUwLjYuMYJtdGVtcGxhdGVkX3VyaWUwLjMuNQ
 [__link0]: https://docs.rs/fetch/0.14.0/fetch/?search=HttpClient
 [__link1]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=RequestHandler
 ...
 [__link14]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpRequestBuilder
 ...
 [__link17]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpRequestBuilder::fetch
 [__link18]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpResponse
 [__link19]: https://docs.rs/fetch/0.14.0/fetch/?search=http::Response
 [__link2]: https://docs.rs/reqwest/
 [__link20]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpResponse::ensure_success
 [__link21]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpResponse::status
 [__link22]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpResponse::headers
 [__link23]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpResponse::into_body
 [__link24]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpBody::into_text
 [__link25]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpBody::into_bytes
 [__link26]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpBody::into_json
 [__link27]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpRequestBuilder::fetch
 ...
 [__link32]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=HttpBody
 ...
 [__link52]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=RequestHandler
 [__link53]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=RequestHandler
 ...
 [__link61]: https://docs.rs/http_extensions/0.7.1/http_extensions/?search=RequestHandler
 ...
 [__link74]: https://crates.io/crates/http_extensions/0.7.1
