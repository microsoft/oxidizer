...
This crate was developed as part of <a href="../..">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/fetch">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: 
 [__link0]: https://docs.rs/fetch/0.10.0/fetch/?search=HttpClient
 [__link1]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=RequestHandler
 ...
 [__link14]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpRequestBuilder
 [__link15]: https://docs.rs/fetch/0.10.0/fetch/?search=HttpClientBuilder::base_uri
 [__link16]: https://docs.rs/templated_uri/0.2.4/templated_uri/?search=BaseUri
 [__link17]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpRequestBuilder::fetch
 [__link18]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpResponse
 [__link19]: https://docs.rs/fetch/0.10.0/fetch/?search=http::Response
 [__link2]: https://docs.rs/reqwest/
 [__link20]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpResponse::ensure_success
 [__link21]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpResponse::status
 [__link22]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpResponse::headers
 [__link23]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpResponse::into_body
 [__link24]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpBody::into_text
 [__link25]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpBody::into_bytes
 [__link26]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpBody::into_json
 [__link27]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpRequestBuilder::fetch
 ...
 [__link32]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=HttpBody
 [__link33]: https://docs.rs/fetch/0.10.0/fetch/?search=http::Response
 [__link34]: https://crates.io/crates/templated_uri/0.2.4
 [__link35]: https://docs.rs/templated_uri/0.2.4/templated_uri/?search=Uri
 [__link36]: https://datatracker.ietf.org/doc/html/rfc6570
 [__link37]: https://docs.rs/templated_uri/0.2.4/templated_uri/?search=Uri
 [__link38]: https://docs.rs/fetch/0.10.0/fetch/?search=handlers::Logging
 [__link39]: https://docs.rs/templated_uri/0.2.4/templated_uri/?search=Uri
 [__link4]: https://docs.rs/fetch/0.10.0/fetch/?search=custom::create_builder
 [__link40]: https://docs.rs/templated_uri/0.2.4/templated_uri/?search=PathAndQueryTemplate
 ...
 [__link47]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=RequestHandler
 [__link48]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=RequestHandler
 ...
 [__link56]: https://docs.rs/http_extensions/0.4.6/http_extensions/?search=RequestHandler
 ...
 [__link64]: https://docs.rs/templated_uri/0.2.4/templated_uri/?search=Uri
 ...
 [__link69]: https://crates.io/crates/http_extensions/0.4.6
 [__link7]: https://docs.rs/fetch/0.10.0/fetch/custom/index.html
 [__link70]: https://crates.io/crates/seatbelt/0.5.4
