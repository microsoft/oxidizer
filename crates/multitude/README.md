...
Fallible allocation and deserialization methods return [`AllocError`][__link87] or
...
sections. The [`Alloc`][__link88], [`ArenaBuilder`][__link89], [`Box`][__link90], [`Rc`][__link91], [`Arc`][__link92], and
...
|Feature|Description|
|-------|-----------|
|`std` *(default)*|Enables [`std::io::Write`][__link93] on [`Vec<u8>`][__link94] for use with `write!`, `std::io::copy`, `serde_json::to_writer`, and similar. Disable for `#![no_std]` environments (the crate still requires `alloc`).|
...
|`serde`|Adds `Serialize` impls for arena strings and vectors, plus arena-aware deserialization through [`de::DeserializeIn`][__link95] and [`Arena::deserialize`][__link96]. With `serde + utf16`, also adds serialization for the UTF-16 types (transcoded to UTF-8 on the wire).|
|`serde_json`|Implies `serde` and adds [`Arena::deserialize_json`][__link97] convenience methods with trailing-input checks and optional resource limits.|
...
|`utf16`|Adds a parallel UTF-16 string surface (`Arc<Utf16Str>`, `Box<Utf16Str>`, [`Utf16String`][__link98], and [`format_utf16!`][__link99]) backed by the [`widestring`][__link100] crate. Lengths are counted in `u16` elements.|
|`zerocopy`|Provides [`ZerocopyView`][__link101] for safe zero-initialized allocation of types implementing [`zerocopy::FromZeros`][__link102]. Access via [`Arena::zerocopy()`][__link103].|
|`bytemuck`|Provides [`BytemuckView`][__link104] for safe zero-initialized allocation of types implementing [`bytemuck::Zeroable`][__link105]. Access via [`Arena::bytemuck()`][__link106].|
|`bytes`|Adds [`From`][__link107] conversions from [`Arc<[u8]>`][__link108] and [`Arc<str>`][__link109] into [`bytes::Bytes`][__link110], enabling zero-copy integration with the Tokio / Hyper async ecosystem.|
|`bytesbuf`|Implements [`bytesbuf::mem::Memory`][__link111] directly on [`Arena`][__link112], so that [`BytesBuf`][__link113] buffers can be backed by arena chunks. Implies `std`.|
|`hashbrown`|Lets [`Arena`][__link114] back [`hashbrown`][__link115] collections via [`Arena::alloc_hash_map`][__link116], [`Arena::alloc_hash_map_with_capacity`][__link117], [`Arena::alloc_set`][__link118], and [`Arena::alloc_set_with_capacity`][__link119].|
...
This crate was developed as part of <a href="https://github.com/microsoft/oxidizer">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/multitude">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGmYW0CYXZlMC43LjNhdIQb11VxC_uAPOQbtUn4Wx2-BfAbid3Nt1Y27Pobprn8Z6FjFy9hYvRhcoQbm6kv9geSd7kbNh0QMjEHvz0bGGoS8IIq6dQbnEDajL2UAuthZIaCaGJ5dGVtdWNrZjEuMjUuMoJlYnl0ZXNmMS4xMi4xgmhieXRlc2J1ZmYwLjEwLjCCaW11bHRpdHVkZWYwLjEwLjCCZXNlcmRlZzEuMC4yMjmCaHplcm9jb3B5ZjAuOC41Nw
 ...
 [__link100]: https://crates.io/crates/widestring
 [__link101]: https://docs.rs/multitude/0.10.0/multitude/?search=zerocopy::ZerocopyView
 [__link102]: https://docs.rs/zerocopy/0.8.57/zerocopy/?search=FromZeros
 [__link103]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::zerocopy
 [__link104]: https://docs.rs/multitude/0.10.0/multitude/?search=bytemuck::BytemuckView
 [__link105]: https://docs.rs/bytemuck/1.25.2/bytemuck/?search=Zeroable
 [__link106]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::bytemuck
 [__link107]: https://doc.rust-lang.org/stable/std/convert/trait.From.html
 [__link108]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link109]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link11]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::format
 [__link110]: https://docs.rs/bytes/1.12.1/bytes/?search=Bytes
 [__link111]: https://docs.rs/bytesbuf/0.10.0/bytesbuf/?search=mem::Memory
 [__link112]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena
 [__link113]: https://docs.rs/bytesbuf/0.10.0/bytesbuf/?search=BytesBuf
 [__link114]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena
 [__link115]: https://crates.io/crates/hashbrown
 [__link116]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_hash_map
 [__link117]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_hash_map_with_capacity
 [__link118]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_set
 [__link119]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_set_with_capacity
 ...
 [__link15]: https://docs.rs/multitude/0.10.0/multitude/?search=Alloc
 [__link16]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link17]: https://docs.rs/multitude/0.10.0/multitude/?search=Rc
 [__link18]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link19]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc
 [__link2]: https://docs.rs/multitude/0.10.0/multitude/?search=Rc
 [__link20]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_box
 [__link21]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_rc
 [__link22]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_arc
 [__link23]: https://docs.rs/multitude/0.10.0/multitude/?search=Alloc
 [__link24]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link25]: https://docs.rs/multitude/0.10.0/multitude/?search=Rc
 [__link26]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 ...
 [__link29]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link3]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link30]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link31]: https://doc.rust-lang.org/stable/alloc/?search=boxed::Box
 [__link32]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena
 [__link33]: https://doc.rust-lang.org/stable/std/marker/trait.Send.html
 [__link34]: https://docs.rs/multitude/0.10.0/multitude/?search=Alloc
 [__link35]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link36]: https://docs.rs/multitude/0.10.0/multitude/?search=vec::Vec
 [__link37]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::String
 [__link38]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::Utf16String
 [__link39]: https://crates.io/crates/allocator-api2
 [__link4]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link40]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::String
 [__link41]: https://docs.rs/multitude/0.10.0/multitude/?search=vec::Vec
 [__link42]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::String::into_boxed_str
 [__link43]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link44]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link45]: https://docs.rs/multitude/0.10.0/multitude/?search=vec::Vec::into_boxed_slice
 [__link46]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link47]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link48]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link49]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link5]: https://docs.rs/multitude/0.10.0/multitude/?search=Rc
 [__link50]: https://docs.rs/multitude/0.10.0/multitude/?search=vec::Vec::leak
 [__link51]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena
 [__link52]: https://crates.io/crates/hashbrown
 [__link53]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_hash_map
 [__link54]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_hash_map_with_capacity
 [__link55]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_set
 [__link56]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_set_with_capacity
 [__link57]: https://docs.rs/multitude/0.10.0/multitude/strings/index.html
 [__link58]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link59]: https://docs.rs/multitude/0.10.0/multitude/?search=Rc
 [__link6]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link60]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link61]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena
 [__link62]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::String
 [__link63]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::Utf16String
 [__link64]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::format
 [__link65]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::format_utf16
 [__link66]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::String
 [__link67]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::String::into_boxed_str
 [__link68]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link69]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::Utf16String
 [__link7]: https://docs.rs/multitude/0.10.0/multitude/?search=Alloc
 [__link70]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::Utf16String::into_boxed_utf16_str
 [__link71]: https://docs.rs/multitude/0.10.0/multitude/?search=de::DeserializeIn
 [__link72]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena
 [__link73]: https://docs.rs/serde/1.0.229/serde/?search=Deserialize
 [__link74]: https://docs.rs/multitude/0.10.0/multitude/?search=de::DeserializeIn
 [__link75]: https://docs.rs/multitude/0.10.0/multitude/de/index.html
 [__link76]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena
 [__link77]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_dst_arc
 [__link78]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_dst_rc
 [__link79]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::alloc_dst_box
 [__link8]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::String
 [__link80]: https://doc.rust-lang.org/stable/core/?search=alloc::Layout
 [__link81]: https://crates.io/crates/dst-factory
 [__link82]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link83]: https://docs.rs/multitude/0.10.0/multitude/?search=Rc
 [__link84]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link85]: `coerce!`
 [__link86]: `coerce!`
 [__link87]: https://docs.rs/multitude/0.10.0/multitude/?search=AllocError
 [__link88]: https://docs.rs/multitude/0.10.0/multitude/?search=Alloc
 [__link89]: https://docs.rs/multitude/0.10.0/multitude/?search=ArenaBuilder
 [__link9]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::Utf16String
 [__link90]: https://docs.rs/multitude/0.10.0/multitude/?search=Box
 [__link91]: https://docs.rs/multitude/0.10.0/multitude/?search=Rc
 [__link92]: https://docs.rs/multitude/0.10.0/multitude/?search=Arc
 [__link93]: https://doc.rust-lang.org/stable/std/?search=io::Write
 [__link94]: https://docs.rs/multitude/0.10.0/multitude/?search=vec::Vec
 [__link95]: https://docs.rs/multitude/0.10.0/multitude/?search=de::DeserializeIn
 [__link96]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::deserialize
 [__link97]: https://docs.rs/multitude/0.10.0/multitude/?search=Arena::deserialize_json
 [__link98]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::Utf16String
 [__link99]: https://docs.rs/multitude/0.10.0/multitude/?search=strings::format_utf16
