...
///
/// Freeze the result with [`Utf16String::into_arena_utf16_str`](crate::strings::Utf16String::into_arena_utf16_str)
/// if you want an immutable [`RcUtf16Str`](crate::strings::RcUtf16Str).
///
/// # Panics
///
