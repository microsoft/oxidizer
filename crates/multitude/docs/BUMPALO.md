...
| `format!`-style macro                             | ✅                          | ✅                                                                                                                                   |
| `#![no_std]`                                      | ✅                          | ✅                                                                                                                                   |
| Smart-pointer width                               | 8 bytes for sized pointees; 16 bytes for wide pointees | 8 bytes for sized, string, and slice pointees; 16 bytes for vtable-metadata pointees                                  |
...
| Dynamically-sized types (e.g. `dyn Trait`, `[T]`) | ✅ owned slices and strings; limited trait-object construction | ✅ strings and slices by default; `Any`/`Error` trait objects by default; annotated custom traits and DST construction behind `dst` |
