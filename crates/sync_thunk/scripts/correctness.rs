...
//! Run the full sync_thunk correctness suite locally.
//!
...
/// Run the full sync_thunk correctness suite.
#[derive(FromArgs)]
struct Args {
...
fn main() -> ExitCode {
    ...
    println!();
    println!("=== sync_thunk Correctness Suite ===");
    println!();
    println!("Toolchains:");
