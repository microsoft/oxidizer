...
/// # Validity
///
/// Types generated by this macro must satisfy the same contract as a manual
/// [`Tunables`] implementation:
///
/// - `partial_slab_scan_limit` must be non-zero.
/// - `size_classes::SIZES` must contain 1 to 48 entries.
/// - Each size class must be non-zero, 16-byte aligned, and strictly
///   increasing.
/// - The final size class must be exactly 16 KiB.
///
/// [`crate::Rallocator::new`] enforces these invariants when the allocator is
/// instantiated.
#[macro_export]
macro_rules! tunable {
    (
