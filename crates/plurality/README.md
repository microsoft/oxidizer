...
* **`std`** *(enabled by default)* — integrates with the standard library
  through [`allocator-api2`][__link14]’s `std` feature. The crate is otherwise
  `no_std` (it needs only [`alloc`][__link15]); disable default features to build for
  a `no_std` target.
...
[`Box<T>`][__link16], [`Arc<T>`][__link17], and [`Rc<T>`][__link18] are generic over `T: ?Sized`, so they can
hold an unsized value — a trait object or a slice — while the value stays in
its pool slot. A sized handle is converted with [`Box::unsize`][__link19] /
[`Arc::unsize`][__link20] / [`Rc::unsize`][__link21], which take a compiler-checked
[`Coercion`][__link22]
token:
...
extra pointer metadata (vtable or length) just like [`alloc::boxed::Box`][__link23], and
...
This crate was developed as part of <a href="https://github.com/microsoft/oxidizer">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/plurality">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGmYW0CYXZlMC43LjJhdIQb11VxC_uAPOQbtUn4Wx2-BfAbid3Nt1Y27Pobprn8Z6FjFy9hYvRhcoQbLKXWdFhkKxcbsvrP3qPv1TcbqlrdqBOol9obhmQO9LEsO9hhZIGCaXBsdXJhbGl0eWUwLjIuMQ
 ...
 [__link14]: https://crates.io/crates/allocator-api2
 [__link15]: https://doc.rust-lang.org/stable/alloc
 ...
 [__link19]: https://docs.rs/plurality/0.2.1/plurality/?search=Box::unsize
 [__link2]: https://docs.rs/plurality/0.2.1/plurality/?search=Alloc
 [__link20]: https://docs.rs/plurality/0.2.1/plurality/?search=Arc::unsize
 [__link21]: https://docs.rs/plurality/0.2.1/plurality/?search=Rc::unsize
 [__link22]: https://docs.rs/plurality/latest/plurality/struct.Coercion.html
 [__link23]: https://doc.rust-lang.org/stable/alloc/?search=boxed::Box
 ...
 [__link8]: https://github.com/microsoft/oxidizer/blob/main/crates/plurality/docs/PERF.md
