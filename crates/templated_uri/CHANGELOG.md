...
- Now requires `0.6.0` of `templated_uri_macros`
...
- 🔧 Maintenance
  ...
  - Now requires `0.2.7` of `templated_uri_macros`
...
- ⚡ Performance
  ...
  - reuse the rendered path across build and routing ([#559](https://github.com/microsoft/oxidizer/pull/559))
