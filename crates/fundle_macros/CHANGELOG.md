...
- 🔧 Maintenance
  ...
  - Now requires `0.3.5` of `fundle_macros_impl`
...
- ✨ Features
  ...
  - Migrate byte_sequences to GitHub ([#56](https://github.com/microsoft/oxidizer/pull/56))
...
- ✨ Features
  ...
  - Migrate bytesbuf to GitHub ([#56](https://github.com/microsoft/oxidizer/pull/56))
