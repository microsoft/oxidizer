...
[`Attempt`][__link1] contains basic information about an execution attempt, such as the current attempt
index and whether this is the first or last attempt. It is typically associated with
[`RecoveryInfo`][__link2] to decide how an operation should be retried or recovered.

## Core Types

* [`RecoveryInfo`][__link3]: Classifies conditions as recoverable (transient) or non-recoverable (permanent/successful).
* [`Recovery`][__link4]: A trait for types that can determine their recoverability.
* [`RecoveryKind`][__link5]: An enum representing the kind of recovery that can be attempted.
* [`Attempt`][__link6]: Represents a single attempt in a resilience operation.
...
This crate was developed as part of <a href="../..">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/recoverable">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGkYW0CYXSEGy4k8ldDFPOhG2VNeXtD5nnKG6EPY6OfW5wBG8g18NOFNdxpYXKEGxUrfb8oCIUAG_JfKUYQH3W_GxPihLRRwZShG757-yP0z3GeYWSBgmtyZWNvdmVyYWJsZWUwLjEuMQ
 [__link0]: https://docs.rs/recoverable/0.1.1/recoverable/?search=RecoveryInfo::never
 [__link1]: https://docs.rs/recoverable/0.1.1/recoverable/?search=Attempt
 [__link2]: https://docs.rs/recoverable/0.1.1/recoverable/struct.RecoveryInfo.html
 [__link3]: https://docs.rs/recoverable/0.1.1/recoverable/struct.RecoveryInfo.html
 [__link4]: https://docs.rs/recoverable/0.1.1/recoverable/trait.Recovery.html
 [__link5]: https://docs.rs/recoverable/0.1.1/recoverable/enum.RecoveryKind.html
 [__link6]: https://docs.rs/recoverable/0.1.1/recoverable/?search=Attempt
