<div align="center">
 <img src="https://raw.githubusercontent.com/microsoft/oxidizer/refs/heads/main/logo.svg" alt="Rallocator Wire Logo" width="96">

# Rallocator Wire

[![crate.io](https://img.shields.io/crates/v/rallocator_wire.svg)](https://crates.io/crates/rallocator_wire)
[![docs.rs](https://docs.rs/rallocator_wire/badge.svg)](https://docs.rs/rallocator_wire)
[![MSRV](https://img.shields.io/crates/msrv/rallocator_wire)](https://crates.io/crates/rallocator_wire)
...
Container format types are available through [`format`][__link0], while byte readers
and writers are available through [`io`][__link1].
