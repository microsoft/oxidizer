...
This crate was developed as part of <a href="../..">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/http_extensions">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGkYW0CYXSEGy4k8ldDFPOhG2VNeXtD5nnKG6EPY6OfW5wBG8g18NOFNdxpYXKEG_MLOQQsiV6zG7SjqsDGgd-WG03lILZ1aMTjG5fuakLrAwKLYWSFgmVieXRlc2YxLjEyLjCCaGJ5dGVzYnVmZTAuNS41gmRodHRwZTEuNC4ygmlodHRwX2JvZHllMS4wLjGCb2h0dHBfZXh0ZW5zaW9uc2UwLjYuMw
 [__link0]: https://crates.io/crates/http/1.4.2
 [__link1]: https://docs.rs/http_extensions/0.6.3/http_extensions/type.HttpRequest.html
 [__link10]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=StatusExt
 [__link11]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=RequestExt
 [__link12]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=ResponseExt
 [__link13]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=HttpRequestExt
 [__link14]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=HeaderMapExt
 [__link15]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=HeaderValueExt
 [__link16]: https://docs.rs/http/1.4.2/http/?search=HeaderValue
 [__link17]: https://docs.rs/bytes/1.12.0/bytes/?search=Bytes
 [__link18]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=ExtensionsExt
 [__link19]: https://docs.rs/http/1.4.2/http/?search=Extensions
 [__link2]: https://docs.rs/http_extensions/0.6.3/http_extensions/type.HttpResponse.html
 [__link20]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=RequestHandler
 [__link21]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=HttpRequestBuilder
 [__link22]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=StatusExt::ensure_success
 ...
 [__link3]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=HttpBody
 [__link30]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=HttpBodyBuilder
 [__link31]: https://crates.io/crates/bytesbuf/0.5.5
 [__link4]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=HttpRequestBuilder
 [__link5]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=HttpResponseBuilder
 [__link6]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=HttpBody
 [__link7]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=HttpBodyBuilder
 [__link8]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=HttpError
 [__link9]: https://docs.rs/http_extensions/0.6.3/http_extensions/?search=RequestHandler
