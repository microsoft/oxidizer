...
///   are usable only inside the crate that defines the error. Rejected under `#[ohno::error]`,
///   which adds the `OhnoCore` field that a hand-written constructor would have to initialize
