...
impl IntoResponse for crate::transcoding::StreamingResponse {
    ...
    fn into_response(self) -> Response {
        ...
        let body = axum_core::body::Body::from_stream(
            frames.map(|item| item.map(bytes::Bytes::from).map_err(crate::transcode_response::StreamingError)),
        );
...
impl IntoResponse for crate::transcoding::TranscodeResponse {
