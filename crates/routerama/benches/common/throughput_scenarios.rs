...
// Concurrent in-process dispatch with identical CPU work and complete body
// observation. Each worker owns a current-thread runtime; setup and barrier
// synchronization are excluded. Environment variables configure the worker,
// slot, and request counts.
