...
use routerama::response::{
    Body, BoxBody, BoxBodyError, EitherBody, IntoResponse, IntoResponseParts, Response, ResponseParts, StaticBytes,
    StaticText,
};
use routerama::route::RawBody;

const FIXED_BYTES: &[u8] = b"fixed-body";
const STATIC_TEXT_SMALL: &str = "hello, Routerama!";
const STATIC_BYTES_SMALL: &[u8] = b"\x00\x01routerama\xfe\xff";
const STATIC_TEXT_MEDIUM: &str = concat!(
    "Routerama serves fixed text without changing its response semantics. ",
    "This medium payload is deliberately large enough to make the current ",
    "copy proportional to payload size while remaining representative of a ",
    "small status page, error explanation, or embedded text asset."
);
const STATIC_BYTES_MEDIUM: &[u8] = b"\x00\x01\x02\x03routerama-static-bytes:\
...
fn observe_response(response: Response) -> ResponseObservation {
    let status = response.status();
    let header_fields = response.headers().len();
    let content_type = response
        .headers()
        .get(CONTENT_TYPE)
        .map(|value| Fingerprint::of(value.as_bytes()));
    let body = observe_success(response.into_body());
    ResponseObservation {
        status,
        header_fields,
        content_type,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
enum Scenario {
    CopiedStaticStrEmpty,
    CopiedStaticStrSmall,
    CopiedStaticStrMedium,
    CopiedStaticBytesEmpty,
    CopiedStaticBytesSmall,
    CopiedStaticBytesMedium,
    StaticTextEmpty,
    StaticTextSmall,
    StaticTextMedium,
    StaticBytesEmpty,
...
impl Scenario {
    const ALL: [Self; 20] = [
        Self::CopiedStaticStrEmpty,
        Self::CopiedStaticStrSmall,
        Self::CopiedStaticStrMedium,
        Self::CopiedStaticBytesEmpty,
        Self::CopiedStaticBytesSmall,
        Self::CopiedStaticBytesMedium,
        Self::StaticTextEmpty,
        Self::StaticTextSmall,
        Self::StaticTextMedium,
        Self::StaticBytesEmpty,
        Self::StaticBytesSmall,
        Self::StaticBytesMedium,
        Self::DirectFixed,
    ...
    const fn group(self) -> &'static str {
        match self {
            ...
            | Self::CopiedStaticBytesEmpty
            | Self::CopiedStaticBytesSmall
            | Self::CopiedStaticBytesMedium => "copied_static",
            Self::StaticTextEmpty
            | Self::StaticTextSmall
            | Self::StaticTextMedium
            | Self::StaticBytesEmpty
            | Self::StaticBytesSmall
            | Self::StaticBytesMedium => "zero_copy_static",
    ...
    const fn name(self) -> &'static str {
        match self {
            Self::CopiedStaticStrEmpty => "str_empty",
            Self::CopiedStaticStrSmall => "str_small",
            Self::CopiedStaticStrMedium => "str_medium",
            Self::StaticTextEmpty => "text_empty",
            Self::StaticTextSmall => "text_small",
            Self::StaticTextMedium => "text_medium",
            Self::CopiedStaticBytesEmpty | Self::StaticBytesEmpty => "bytes_empty",
            Self::CopiedStaticBytesSmall | Self::StaticBytesSmall => "bytes_small",
            Self::CopiedStaticBytesMedium | Self::StaticBytesMedium => "bytes_medium",
    ...
    const fn diagnostic_name(self) -> &'static str {
        match self {
            Self::CopiedStaticStrEmpty => "copied_static/str_empty",
            Self::CopiedStaticStrSmall => "copied_static/str_small",
            Self::CopiedStaticStrMedium => "copied_static/str_medium",
            Self::CopiedStaticBytesEmpty => "copied_static/bytes_empty",
            Self::CopiedStaticBytesSmall => "copied_static/bytes_small",
            Self::CopiedStaticBytesMedium => "copied_static/bytes_medium",
            Self::StaticTextEmpty => "zero_copy_static/text_empty",
            Self::StaticTextSmall => "zero_copy_static/text_small",
            Self::StaticTextMedium => "zero_copy_static/text_medium",
            Self::StaticBytesEmpty => "zero_copy_static/bytes_empty",
            Self::StaticBytesSmall => "zero_copy_static/bytes_small",
            Self::StaticBytesMedium => "zero_copy_static/bytes_medium",
    ...
    const fn setup_operation(self) -> &'static str {
        match self {
            Self::CopiedStaticStrEmpty => "copied_static_str_empty_setup",
            Self::CopiedStaticStrSmall => "copied_static_str_small_setup",
            Self::CopiedStaticStrMedium => "copied_static_str_medium_setup",
            Self::CopiedStaticBytesEmpty => "copied_static_bytes_empty_setup",
            Self::CopiedStaticBytesSmall => "copied_static_bytes_small_setup",
            Self::CopiedStaticBytesMedium => "copied_static_bytes_medium_setup",
            Self::StaticTextEmpty => "static_text_empty_setup",
            Self::StaticTextSmall => "static_text_small_setup",
            Self::StaticTextMedium => "static_text_medium_setup",
            Self::StaticBytesEmpty => "static_bytes_empty_setup",
            Self::StaticBytesSmall => "static_bytes_small_setup",
            Self::StaticBytesMedium => "static_bytes_medium_setup",
    ...
    const fn measured_operation(self) -> &'static str {
        match self {
            Self::CopiedStaticStrEmpty => "copied_static_str_empty_measured",
            Self::CopiedStaticStrSmall => "copied_static_str_small_measured",
            Self::CopiedStaticStrMedium => "copied_static_str_medium_measured",
            Self::CopiedStaticBytesEmpty => "copied_static_bytes_empty_measured",
            Self::CopiedStaticBytesSmall => "copied_static_bytes_small_measured",
            Self::CopiedStaticBytesMedium => "copied_static_bytes_medium_measured",
            Self::StaticTextEmpty => "static_text_empty_measured",
            Self::StaticTextSmall => "static_text_small_measured",
            Self::StaticTextMedium => "static_text_medium_measured",
            Self::StaticBytesEmpty => "static_bytes_empty_measured",
            Self::StaticBytesSmall => "static_bytes_small_measured",
            Self::StaticBytesMedium => "static_bytes_medium_measured",
    ...
    const fn static_payload(self) -> Option<&'static [u8]> {
        match self {
            Self::CopiedStaticStrEmpty
            | Self::CopiedStaticBytesEmpty
            | Self::StaticTextEmpty
            | Self::StaticBytesEmpty => Some(b""),
            Self::CopiedStaticStrSmall | Self::StaticTextSmall => Some(STATIC_TEXT_SMALL.as_bytes()),
            Self::CopiedStaticStrMedium | Self::StaticTextMedium => Some(STATIC_TEXT_MEDIUM.as_bytes()),
            Self::CopiedStaticBytesSmall | Self::StaticBytesSmall => Some(STATIC_BYTES_SMALL),
            Self::CopiedStaticBytesMedium | Self::StaticBytesMedium => Some(STATIC_BYTES_MEDIUM),
            Self::DirectFixed
            | Self::DirectConcreteStream
            | Self::DirectBoxBody
            | Self::GeneratedFixed
            ...
            | Self::GeneratedBoxBody
            | Self::GeneratedConcreteError
            | Self::BoxedError => None,
        }
    }

    const fn static_content_type(self) -> Option<&'static [u8]> {
        match self {
            Self::CopiedStaticStrEmpty
            | Self::CopiedStaticStrSmall
            | Self::CopiedStaticStrMedium
            | Self::StaticTextEmpty
            | Self::StaticTextSmall
            | Self::StaticTextMedium => Some(b"text/plain; charset=utf-8"),
            Self::CopiedStaticBytesEmpty
            | Self::CopiedStaticBytesSmall
            | Self::CopiedStaticBytesMedium
            | Self::StaticBytesEmpty
...
enum PreparedScenario {
    CopiedStaticStr(&'static str),
    CopiedStaticBytes(&'static [u8]),
...
fn prepare(scenario: Scenario) -> PreparedScenario {
    match scenario {
        Scenario::CopiedStaticStrEmpty => PreparedScenario::CopiedStaticStr(""),
        Scenario::CopiedStaticStrSmall => PreparedScenario::CopiedStaticStr(STATIC_TEXT_SMALL),
        Scenario::CopiedStaticStrMedium => PreparedScenario::CopiedStaticStr(STATIC_TEXT_MEDIUM),
        Scenario::CopiedStaticBytesEmpty => PreparedScenario::CopiedStaticBytes(b""),
        Scenario::CopiedStaticBytesSmall => PreparedScenario::CopiedStaticBytes(STATIC_BYTES_SMALL),
        Scenario::CopiedStaticBytesMedium => PreparedScenario::CopiedStaticBytes(STATIC_BYTES_MEDIUM),
        Scenario::StaticTextEmpty => PreparedScenario::StaticText(""),
        Scenario::StaticTextSmall => PreparedScenario::StaticText(STATIC_TEXT_SMALL),
        Scenario::StaticTextMedium => PreparedScenario::StaticText(STATIC_TEXT_MEDIUM),
        Scenario::StaticBytesEmpty => PreparedScenario::StaticBytes(b""),
        Scenario::StaticBytesSmall => PreparedScenario::StaticBytes(STATIC_BYTES_SMALL),
        Scenario::StaticBytesMedium => PreparedScenario::StaticBytes(STATIC_BYTES_MEDIUM),
...
fn run_prepared(prepared: PreparedScenario) -> ScenarioObservation {
    match std::hint::black_box(prepared) {
        PreparedScenario::CopiedStaticStr(text) => {
            ScenarioObservation::Response(observe_response(std::hint::black_box(text).into_response()))
        }
        PreparedScenario::CopiedStaticBytes(bytes) => {
            ScenarioObservation::Response(observe_response(Body::from(std::hint::black_box(bytes)).into_response()))
        }
        PreparedScenario::StaticText(text) => {
            ScenarioObservation::Response(observe_response(StaticText(std::hint::black_box(text)).into_response()))
        }
        PreparedScenario::StaticBytes(bytes) => {
            ScenarioObservation::Response(observe_response(StaticBytes(std::hint::black_box(bytes)).into_response()))
        }
...
fn expected_single_frame_observation(bytes: &'static [u8]) -> BodyObservation {
    let mut observation = BodyObservation {
        initial_end_stream: bytes.is_empty(),
        final_end_stream: true,
        initial_size_hint: HintObservation::exact(bytes.len() as u64),
        data_frames: 0,
        data_bytes: 0,
        data: Fingerprint::empty(),
        trailer_frames: 0,
    ...
    if !bytes.is_empty() {
        observation.observe_data(&Bytes::from_static(bytes));
    }
    observation
}

fn expected_response_observation(bytes: &'static [u8], content_type: Option<&'static [u8]>) -> ResponseObservation {
    ResponseObservation {
        status: StatusCode::OK,
        header_fields: usize::from(content_type.is_some()),
        content_type: content_type.map(Fingerprint::of),
        body: expected_single_frame_observation(bytes),
    }
}
...
fn assert_equivalent() {
    ...
    for scenario in Scenario::ALL {
        match (scenario, run_prepared(prepare(scenario))) {
            (
                Scenario::CopiedStaticStrEmpty
                | Scenario::CopiedStaticStrSmall
                | Scenario::CopiedStaticStrMedium
                | Scenario::CopiedStaticBytesEmpty
                | Scenario::CopiedStaticBytesSmall
                | Scenario::CopiedStaticBytesMedium
                | Scenario::StaticTextEmpty
                | Scenario::StaticTextSmall
                | Scenario::StaticTextMedium
                | Scenario::StaticBytesEmpty
                | Scenario::StaticBytesSmall
                | Scenario::StaticBytesMedium,
                ScenarioObservation::Response(observation),
            ) => assert_eq!(
                observation,
                expected_response_observation(
                    scenario.static_payload().expect("static-response scenarios always have a payload"),
                    scenario.static_content_type(),
                ),
                "{} changed status, headers, payload bytes, frame count, or size hints",
...
fn allocation_diagnostics() -> [AllocationDiagnostic; 20] {
    Scenario::ALL.map(|scenario| {
        ...
        let prepared = {
            let _span = setup_operation.measure_thread().iterations(1);
            std::hint::black_box(prepare(scenario))
        };
        let measured_operation = session.operation(scenario.measured_operation());
        {
            let _span = measured_operation.measure_thread().iterations(1);
