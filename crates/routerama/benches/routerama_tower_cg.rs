...
//!
//! Paired with `routerama_tower.rs`. The generated exact case keeps the private
//! concrete body behind an opaque service type; the `SendBoxBody` case includes
//! its allocator call because that allocation is the explicit erasure cost.
...
mod linux {
    ...
    benchmark_case!(dispatch_generated_exact_tower, GeneratedExactTower);
    ...
    library_benchmark_group!(
        ...
        benchmarks =
            ...
            dispatch_generated_exact_tower,
