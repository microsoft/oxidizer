...
///
/// Narrow nodes use a weight-ordered linear scan; wider nodes use a key-sorted
/// binary search. [`RtNode::compile`](RtNode::compile) and [`find_literal`]
/// must apply the same threshold.
