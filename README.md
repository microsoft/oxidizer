...
- [`rest_over_grpc`](./crates/rest_over_grpc/README.md) - Framework-neutral runtime for transcoding gRPC services to REST/JSON endpoints.
- [`rest_over_grpc_build`](./crates/rest_over_grpc_build/README.md) - Build-time codegen that turns google.api.http-annotated gRPC services into REST routers.
