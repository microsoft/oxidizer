...
Facts use `schemaVersion: 4`; regenerate them when the release tooling changes.
...
modified, modifiedFiles, modifiedFileCount, manifestDependencyScopes,
manifestOtherChanged, workspaceModified`.
