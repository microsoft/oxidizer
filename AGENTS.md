...
The changelogs are updated by the `release-packages` skill at release time, based on Git history. It is not necessary to make manual edits
...
workflow for `.github/skills/release-packages/SKILL.md`.
